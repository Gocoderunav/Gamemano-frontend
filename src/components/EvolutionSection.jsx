...
const EvolutionSection = () => {
  return (
    <div className="relative min-h-screen bg-black flex flex-col items-center justify-center text-white px-6 py-12">
      ...
      {/* Center Content */}
      <div className="flex flex-col items-center ml-60 max-w-3xl w-full mx-auto text-center">
        
        {/* Title */}
        <h1 className="text-7xl md:text-8xl font-bold mb-2 tracking-wider">Evolution</h1>

        {/* Release Date */}
        <div className="bg-gray-900 flex justify-end bg-opacity-70 ml-62 w-160 px-4 py-2 mr-20 mb-8 rounded-sm">
  <p className="text-xs text-right font-semibold tracking-widest">
    RELEASE DATE : 30TH DECEMBER
        ...
        {/* Description */}
        <p className="text-gray-300 text-left leading-relaxed ml-36 mb-12 text-lg max-w-2xl">
